...
class TestRotationYamlFilesParse(unittest.TestCase):
    ...
    def test_rotation_members_yaml_parses(self):
        parsed = rotations.RotationMembersFile.parse_file(rotations.ROTATION_MEMBERS_FILE)
        self.assertTrue(parsed.members, "No rotation members could be parsed")

    def test_rotation_yaml_parses(self):
